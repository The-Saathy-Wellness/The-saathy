...
import styles from "./FrameComponent111111111111.module.css";

export type FrameComponent111111111111Type = {
  className?: string;
};

const FrameComponent111111111111: FunctionComponent<
  FrameComponent111111111111Type
> = ({ className = "" }) => {
  return (
...
export default FrameComponent111111111111;
