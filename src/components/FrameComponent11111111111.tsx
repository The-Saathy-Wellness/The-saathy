...
import styles from "./FrameComponent11111111111.module.css";

export type FrameComponent11111111111Type = {
  className?: string;
};

const FrameComponent11111111111: FunctionComponent<
  FrameComponent11111111111Type
> = ({ className = "" }) => {
  return (
...
export default FrameComponent11111111111;
